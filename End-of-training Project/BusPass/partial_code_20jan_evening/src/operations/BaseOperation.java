...
public class BaseOperation {
	...
	public String getFirstName() throws UserException {
		...
		try {
			...
			throw new UserException("Enetered name is invalid");
		}
		
		if(!Validator.isValidNameLenght(firstName)) {
			throw new UserException("first name shoulb be less than 60 characters");
		}
		return firstName;
	}
	
	public String getLastName() throws UserException {
		Scanner objs = OperationFactory.getScannerInstance();
		...
		if(!Validator.isValidNameLenght(lastName)) {
			throw new UserException("first name shoulb be less than 60 characters");
		}
		return lastName;
	}
	...
	protected String getFullName() throws UserException {
	  ...
	  protected String getContactNo() throws UserException {
	    ...
	    if (!Validator.isvalidPhoneNum(contactNo)) {
	  ...
	  protected String getExistingPassword(int userId) throws UserException, AppException {
	    Scanner sc = OperationFactory.getScannerInstance();
