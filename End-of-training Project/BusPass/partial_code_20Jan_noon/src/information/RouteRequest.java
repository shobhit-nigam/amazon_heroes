 ...
 * routeExists - Stores boolean route existence state, is both stops are currently present 
 * 					in a route 
 * stopsExist - Stores boolean stops existence state, is either of the stops are 
 * 					not supported and do not have id(s).  
